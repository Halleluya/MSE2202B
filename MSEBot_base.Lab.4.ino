...
//constants
// EEPROM addresses
const int const_Grip_Servo_Open = 110;    
const int const_Grip_Servo_Closed = 40;
...
const int const_Wrist_Servo_Down = 15; 
...
unsigned int zeroLeftHall, zeroMiddleHall, zeroRightHall = 0;
              ...
              case 2:
              {
                 ...
                 {  
                  ...
                  if(left_clawHallValue<500 || left_clawHallValue>507 || right_clawHallValue<510 || right_clawHallValue>520)
                  {
                    ...
                    while(encoder_RightMotor.getRawPosition()<1500)//might need to change while statment for encoder position (robot dependet)
                    {
                        leftMotorSpeed = 1770;
                        rightMotorSpeed = 1700;
                        stabalizeMotorSpeeds();
                    ...
                    //detach motors and wrist servo to give arm motor enough current to raise arm
